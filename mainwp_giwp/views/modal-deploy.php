...
?>
<div id="mainwp-giweb-deploy-modal" class="mainwp-giweb-modal" aria-hidden="true" role="dialog" aria-labelledby="mainwp-giweb-deploy-modal-title">
	...
	<div class="mainwp-giweb-modal__dialog">
		<header class="mainwp-giweb-modal__header">
			<h2 id="mainwp-giweb-deploy-modal-title"><?php esc_html_e( 'Déploiement de la configuration', 'mainwp-giweb' ); ?></h2>
		</header>
		<div class="mainwp-giweb-modal__body">
			...
			<div class="mainwp-giweb-sync-log mainwp-giweb-deploy-log" aria-live="polite" aria-relevant="additions"></div>
		</div>
