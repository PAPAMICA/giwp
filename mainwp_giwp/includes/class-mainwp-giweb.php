		...
		return array(
			...
			'i18n'    => array(
				...
				'pullJsMissing'  => __( 'Scripts non chargés : soumission du formulaire…', 'mainwp-giweb' ),
					...
					'deployDoneFailed' => __( 'Échec du déploiement sur tous les sites (%d). Consultez les messages détaillés ci-dessus ou l’historique.', 'mainwp-giweb' ),
					'historyDetailTitle' => __( 'Détail du déploiement #', 'mainwp-giweb' ),
					'historyDetailError' => __( 'Impossible de charger le détail du déploiement.', 'mainwp-giweb' ),
					'deployNoSites'    => __( 'Sélectionnez au moins un site.', 'mainwp-giweb' ),
					'pluginDeployTitle'    => __( 'Déploiement GI-Toolkit', 'mainwp-giweb' ),
					'pluginDeployStarting' => __( 'Préparation du déploiement du plugin…', 'mainwp-giweb' ),
					'pluginDeployConnecting' => __( 'Déploiement vers %s…', 'mainwp-giweb' ),
					'pluginDeployDone'       => __( 'Déploiement du plugin terminé.', 'mainwp-giweb' ),
					'pluginDeployDoneOk'     => __( 'GI-Toolkit déployé sur %d site(s).', 'mainwp-giweb' ),
					'pluginDeployDonePartial' => __( 'Déploiement terminé : %1$d réussi(s), %2$d en échec.', 'mainwp-giweb' ),
					'pluginDeployDoneFailed' => __( 'Échec du déploiement sur tous les sites (%d).', 'mainwp-giweb' ),
					...
					'fullDeployConfirm'      => __( 'Mettre à jour GI-Toolkit puis déployer la configuration sur les sites sélectionnés ?', 'mainwp-giweb' ),
					'fullDeployPhasePlugin'  => __( '=== Phase 1 : mise à jour GI-Toolkit ===', 'mainwp-giweb' ),
					'fullDeployPhaseConfig'  => __( '=== Phase 2 : déploiement de la configuration ===', 'mainwp-giweb' ),
					'fullDeployDone'         => __( 'Terminé (plugin + configuration).', 'mainwp-giweb' ),
					'fullDeployDonePartial'  => __( 'Terminé avec des erreurs (plugin et/ou configuration).', 'mainwp-giweb' ),
					'fullDeployPluginFailed' => __( 'Mise à jour plugin interrompue — configuration non lancée.', 'mainwp-giweb' ),
