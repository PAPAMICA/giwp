...
if ( ! defined( 'MAINWP_GIWEB_VERSION' ) ) {
	define( 'MAINWP_GIWEB_VERSION', '1.7.10' );
}
...
require_once MAINWP_GIWEB_PLUGIN_PATH . 'includes/class-mainwp-giweb-pushover.php';
...
require_once MAINWP_GIWEB_PLUGIN_PATH . 'includes/class-mainwp-giweb-rest.php';
