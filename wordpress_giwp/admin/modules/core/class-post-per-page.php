 ...
 * @since 1.4.0
 */
class Gi_Toolkit_Post_Per_Page {
    ...
    public function __construct() {
        ...
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_post_per_page';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Post Per Page', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        ...
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-post-per-page', 
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/post-per-page.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/post-per-page.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/post-per-page.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc"><?php esc_html_e('Specifying the number of posts to display per page, for each post type.', 'gi-toolkit'); ?></div>
