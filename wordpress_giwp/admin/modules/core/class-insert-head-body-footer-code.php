 ...
 * @since 1.5.0
 */
class Gi_Toolkit_Insert_Head_Body_Footer_Code {
    ...
    public function __construct() {
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_insert_head_body_footer_code';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Insert <head>, <body> and <footer> Code', 'gi-toolkit' );
    ...
    public function add_submenu(){
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-insert-head-body-footer-code', 
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/insert-head-body-footer-code.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/insert-head-body-footer-code.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/insert-head-body-footer-code.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
        wp_localize_script( 'Gi_Toolkit_submenu', 'gi_toolkit_code_snippets', array(
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc"><?php esc_html_e( "Easily insert <meta>, <link>, <script> and <style> tags, Google Analytics, Tag Manager, AdSense, Ads Conversion and Optimize code, Facebook, TikTok and Twitter pixels, etc.", 'gi-toolkit'); ?></div>
                <div class="gi-toolkit__section__body">
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Code to insert before </head>', 'gi-toolkit'); ?></div>
						<div class="gi-toolkit__section__body__item__content flex flex-wrap">
							<div class="gi-toolkit__input-text flex">
								<div><?php esc_html_e( 'Priority', 'gi-toolkit'); ?></div>
								<div>
								...
								<div>
									<?php esc_html_e( 'Larger number insert code closer to </head>', 'gi-toolkit' ); ?>
								</div>
							</div>
					...
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Code to insert after <body>', 'gi-toolkit'); ?></div>
						<div class="gi-toolkit__section__body__item__content flex flex-wrap">
							<div class="gi-toolkit__input-text flex">
								<div><?php esc_html_e( 'Priority', 'gi-toolkit'); ?></div>
								<div>
								...
								<div>
									<?php esc_html_e( 'Smaller number insert code closer to <body>', 'gi-toolkit' ); ?>
								</div>
							</div>
					...
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Code to insert before </body>', 'gi-toolkit'); ?></div>
						<div class="gi-toolkit__section__body__item__content flex flex-wrap">
							<div class="gi-toolkit__input-text flex">
								<div><?php esc_html_e( 'Priority', 'gi-toolkit'); ?></div>
								<div>
								...
								<div>
									<?php esc_html_e( 'Larger number insert code closer to </body>', 'gi-toolkit' ); ?>
								</div>
							</div>
