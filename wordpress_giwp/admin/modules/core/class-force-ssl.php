...
class Gi_Toolkit_Force_SSL {
    ...
    public static function activate() {
        ...
        Gi_Toolkit_WP_Config::replace_or_add_constant( 'FORCE_SSL_ADMIN', true );
        Gi_Toolkit_WP_Config::replace_or_add_constant( 'FORCE_SSL_LOGIN', true );
    ...
    public static function deactivate() {
        ...
        Gi_Toolkit_WP_Config::remove_constant( 'FORCE_SSL_ADMIN' );
        Gi_Toolkit_WP_Config::remove_constant( 'FORCE_SSL_LOGIN' );
