 ...
 * @since 1.0.0
 */
class Gi_Toolkit_Last_Login_Column {
    ...
    public function save_login_timestamp( $user_login, $user ) {
        ...
        update_user_meta( $user->ID, 'Gi_Toolkit_last_login_timestamp', time() );
    }
    ...
    public function add_custom_columns( $columns ) {
        ...
        $columns['Gi_Toolkit_last_login'] = esc_html__( 'Last Login', 'gi-toolkit' );
    ...
    public function add_custom_columns_content( $output, $column_name, $user_id ) {
        ...
        if ( $column_name === 'Gi_Toolkit_last_login' ) {
            
            $last_login_timestamp = get_user_meta( $user_id, 'Gi_Toolkit_last_login_timestamp', true );
            ...
            if ( !empty( $last_login_timestamp ) ) {
                ...
                $output = esc_html__( 'No data yet', 'gi-toolkit' );
            }
        }
