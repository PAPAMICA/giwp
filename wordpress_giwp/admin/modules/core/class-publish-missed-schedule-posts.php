 ...
 * @since 1.3.0
 */
class Gi_Toolkit_Publish_Missed_Schedule_Posts {

    const TRANSIENT_ID = 'gi_toolkit_missed_schedule_posts';
    ...
    public function publish_missed_schedule_posts() {
        ...
        if ( is_front_page() || is_home() || is_page() || is_single() || is_singular() || is_archive() || is_admin() || is_blog_admin() || is_robots() || is_ssl() ) {
            ...
            if ( false === $missed_schedule_posts ) {
                 ...
                 */
                $post_types = apply_filters( 'gi_toolkit/publish_missed_schedule_posts/post_types', $post_types );
                 ...
                 */
                $transient_expiration = apply_filters( 'gi_toolkit/publish_missed_schedule_posts/transient_expiration', 30 * MINUTE_IN_SECONDS );
