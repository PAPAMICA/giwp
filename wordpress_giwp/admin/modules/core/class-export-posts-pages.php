 ...
 * @since 1.3.0
 */
class Gi_Toolkit_Export_Posts_Pages {

    const ACTION = 'gi_toolkit_export_posts_pages';
    const NONCE  = 'gi_toolkit_export_posts_pages_nonce';
    ...
    public function download_post() {
        ...
        if ( ! current_user_can( 'export' ) ) {
            wp_die( esc_html__( 'Droits insuffisants pour exporter ce contenu.', 'gi-toolkit' ) );
        }
