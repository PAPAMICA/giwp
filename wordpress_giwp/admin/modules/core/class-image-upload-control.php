 ...
 * @since 1.5.0
 */
class Gi_Toolkit_Image_Upload_Control {
    ...
    public function __construct() {
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_image_upload_control';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Image Upload Control', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-image-upload-control',
    ...
    public function render_submenu() {
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/image-upload-control.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/image-upload-control.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/image-upload-control.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc">
					<?php esc_html_e( "Resize newly uploaded, large images to a smaller dimension and delete originally uploaded files. BMPs and non-transparent PNGs will be converted to JPGs and resized.", 'gi-toolkit'); ?>
					</br>
					<?php 
                    echo esc_html( sprintf(
                        /* translators: %1$s: prefix_to_ignore */
                        __( 'To exclude an image from conversion and resizing, append \'%1$s\' suffix to the file name, e.g. my-image%1$s.jpg', 'gi-toolkit' ), 
                ...
                <div class="gi-toolkit__section__body">
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'Max Width', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
                            <div class="gi-toolkit__input-text">
								...
								<?php esc_html_e( 'pixels', 'gi-toolkit' ); ?>
                            </div>
							<div class="description"><?php esc_html_e( '(Default is 1920 pixels)', 'gi-toolkit' ); ?></div>
                        </div>
                    </div>
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'Max Height', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
                            <div class="gi-toolkit__input-text">
