 ...
 * @since 1.0.0
 */
class Gi_Toolkit_Hide_Admin_Bar {
    ...
    public function __construct() {
        ...
        $this->option_id        = GI_TOOLKIT_PLUGIN_SETTINGS . '_hide_admin_bar';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Hide Admin Bar', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        ...
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-hide-admin-bar', 
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/hide-admin-bar.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/hide-admin-bar.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/hide-admin-bar.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc"><?php esc_html_e('Hide the admin bar on the front end of your website for either specific user roles or all users.', 'gi-toolkit'); ?></div>
                            ...
                            <?php foreach ( $user_roles as $role_slug => $role_label ): ?>
                                <div class="gi-toolkit__checkbox">
                                    <label class="gi-toolkit__checkbox__label">
                                        ...
                                        <span class="gi-toolkit__checkbox__label__text"><?php echo esc_html($role_label); ?> <span>(<?php echo esc_html($role_slug); ?>)</span></span>
                                    </label>
                                </div>
                            <?php endforeach; ?>
                        </div>
