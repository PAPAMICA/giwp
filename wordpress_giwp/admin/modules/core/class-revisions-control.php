 ...
 * @since 1.3.0
 */
class Gi_Toolkit_Revisions_Control {
    ...
    public function __construct() {
        ...
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_revisions_control';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Revisions Control', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        ...
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-revisions-control',
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/revisions-control.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/revisions-control.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/revisions-control.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc"><?php esc_html_e('Avoid overloading the database by setting a cap on the number of revisions to save for certain or all types of posts that support revisions.', 'gi-toolkit'); ?></div>
					...
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__content">
							<label class="gi-toolkit__toggle">
								...
								<input type="checkbox" name="<?php echo esc_attr( $this->option_id . '[global][enabled]' ); ?>" value="1" <?php checked( $this->settings['global']['enabled'] ?? '', 1 ); ?> id="JS-gi_toolkit-revisions-control-toggle">
								<span class="gi-toolkit__toggle__slider round"></span>
							</label>
							<?php esc_html_e("Manage revisions globally", 'gi-toolkit'); ?>
                        </div>
                    </div>

					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__content" id="JS-gi_toolkit-revisions-control-global" style="<?php echo $this->settings['global']['enabled'] ? '' : 'display: none;'; ?>">
							<div class="gi-toolkit__input-text">
								...
								<span class="gi-toolkit__checkbox-number__label__text"><?php esc_html_e( 'All post types', 'gi-toolkit' ); ?></span>
                            </div>
						</div>
					</div>

                    <div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__content flex flex-wrap" id="JS-gi_toolkit-revisions-control-post-types" style="<?php echo $this->settings['global']['enabled'] ? 'display: none;' : ''; ?>">
                            <?php foreach ( $post_types as $post_type ): ?>

                                <div class="gi-toolkit__checkbox-number">
                                    <label class="gi-toolkit__checkbox-number__label">

                                        <div class="gi-toolkit__checkbox-number__label__checkbox">
                                        ...
                                        <div class="gi-toolkit__checkbox-number__label__number">
                                        ...
                                        <span class="gi-toolkit__checkbox-number__label__text"><?php echo esc_html($post_type->label); ?> <span>(<?php echo esc_html($post_type->name); ?>)</span></span>
                                    </label>
                                </div>
