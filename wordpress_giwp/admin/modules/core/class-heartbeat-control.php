 ...
 * @since 1.5.0
 */
class Gi_Toolkit_Heartbeat_Control {
    ...
    public function __construct() {
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_heartbeat_control';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Heartbeat Control', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-heartbeat-control',
    ...
    public function render_submenu() {
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/heartbeat-controle.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/heartbeat-controle.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/heartbeat-controle.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
        ...
        return array(
			'admin_pages'   => array(
				'controle' => array(
					'value'   => 'default',
					'options' => array(
						'default' => __( 'Keep as is', 'gi-toolkit' ),
						'modify'  => __( 'Modify', 'gi-toolkit' ),
						'disable' => __( 'Disable', 'gi-toolkit' ),
					),
				),
				'interval' => array(
					'value'   => '60',
					'options' => array(
						'15'  => __( '15 seconds', 'gi-toolkit' ),
						'30'  => __( '30 seconds', 'gi-toolkit' ),
						'60'  => __( '1 minute', 'gi-toolkit' ),
						'120' => __( '2 minutes', 'gi-toolkit' ),
						'180' => __( '3 minutes', 'gi-toolkit' ),
						'300' => __( '5 minutes', 'gi-toolkit' ),
						'600' => __( '10 minutes', 'gi-toolkit' ),
					),
				),
			),
			'post_creation'   => array(
				...
				'interval' => array(
					...
					'options' => array(
						'15'  => __( '15 seconds', 'gi-toolkit' ),
						'30'  => __( '30 seconds', 'gi-toolkit' ),
						'45'  => __( '45 seconds', 'gi-toolkit' ),
						'60'  => __( '60 seconds', 'gi-toolkit' ),
						'90'  => __( '90 seconds', 'gi-toolkit' ),
						'120' => __( '120 seconds', 'gi-toolkit' ),
					),
				),
			),
			'frontend'   => array(
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc">
					<?php esc_html_e( "Modify the interval of the WordPress heartbeat API or disable it on admin pages, post creation/edit screens and/or the frontend. This will help reduce CPU load on the server.", 'gi-toolkit'); ?>
				</div>
                <div class="gi-toolkit__section__body">

					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'On admin pages', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							...
							<div class="gi-toolkit__select" <?php echo $admin_pages_controle !== 'modify' ? 'style="display: none;"' : ''; ?>>
								<span><?php esc_html_e( 'Set interval to once every', 'gi-toolkit' ); ?></span>
					...
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'On post creation and edit screens', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							<div class="gi-toolkit__radio">
							...
							<div class="gi-toolkit__select" <?php echo $post_creation_controle !== 'modify' ? 'style="display: none;"' : ''; ?>>
								<span><?php esc_html_e( 'Set interval to once every', 'gi-toolkit' ); ?></span>
					...
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'On the frontend', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							<div class="gi-toolkit__radio">
							...
							<div class="gi-toolkit__select" <?php echo $frontend_controle !== 'modify' ? 'style="display: none;"' : ''; ?>>
								<span><?php esc_html_e( 'Set interval to once every', 'gi-toolkit' ); ?></span>
