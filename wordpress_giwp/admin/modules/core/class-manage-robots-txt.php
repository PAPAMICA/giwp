 ...
 * @since 1.5.0
 */
class Gi_Toolkit_Manage_Robots_Txt {
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Manage robots.txt', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-manage-robots-txt',
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/manage-robots-txt.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/manage-robots-txt.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/manage-robots-txt.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
            ...
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc">
                    ...
                    echo wp_kses_post( sprintf(
                        ...
                        __( "Easily edit and validate your %s.", 'gi-toolkit' ), 
                ...
                <div class="gi-toolkit__section__body">
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('robots.txt', 'gi-toolkit'); ?></div>
