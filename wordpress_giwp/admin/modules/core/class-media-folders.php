	...
	private function get_js_config() {
		return array(
			...
			'i18n'    => array(
				...
				'searchFolders'   => __( 'Rechercher un dossier…', 'gi-toolkit' ),
				'viewExplorer'    => __( 'Explorateur', 'gi-toolkit' ),
				'viewTree'        => __( 'Liste', 'gi-toolkit' ),
				'breadcrumbHome'  => __( 'Accueil', 'gi-toolkit' ),
				'breadcrumbLabel' => __( 'Emplacement actuel', 'gi-toolkit' ),
				'expandFolder'    => __( 'Développer le dossier', 'gi-toolkit' ),
