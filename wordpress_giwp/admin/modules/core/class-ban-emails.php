...
class Gi_Toolkit_Ban_Emails {
    ...
    public function __construct() {
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_ban_emails';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Ban emails', 'gi-toolkit' );
    }
	...
	public function verify_emails( $sanitized_user_login, $user_email, $errors ) {
		...
		if ( $email_not_accepted ) {
			...
			$message = sprintf(
                ...
                __( '%1$sError:%2$s Your email is not accepted.', 'gi-toolkit' ), 
                '<strong>', 
                '</strong>'
            );
    ...
    public function add_submenu(){
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-ban-emails',
    ...
    public function render_submenu() {
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/ban-emails.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/ban-emails.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/ban-emails.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc">
					<?php esc_html_e( "Ban the chosen emails.", 'gi-toolkit'); ?>
				</div>
                <div class="gi-toolkit__section__body">

					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'Redirect Blocked Users', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							...
							<div class="gi-toolkit__checkbox">
								<label class="gi-toolkit__checkbox__label">
									...
									<span class="gi-toolkit__checkbox__label__text"><?php esc_html_e( 'Redirect failed logins to a custom URL.', 'gi-toolkit' ); ?></span>
								</label>
							</div>
							...
							<div class="description"><?php esc_html_e( 'Set redirect URL (example: http://example.com).', 'gi-toolkit' ); ?></div>
                        </div>
                    </div>

					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'The Blocked List', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							...
							<div class="description"><?php esc_html_e( 'Add each item on one line.', 'gi-toolkit' ); ?></div>
							<div class="description"><?php esc_html_e( 'The terms below will not be allowed to be used during registration. You can add in full emails (i.e. foo@domain.com) or domains (i.e. @domain.com), and partials (i.e. foo). Wildcards (i.e. *) will not work.', 'gi-toolkit' ); ?></div>
                        </div>
                    </div>
