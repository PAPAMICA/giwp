 ...
 * @since 1.5.0
 */
class Gi_Toolkit_Obfuscate_Author_Slugs {
	...
	private function encrypt( $user_id ) {
        ...
        return bin2hex( openssl_encrypt( base_convert( $user_id, 10, 36 ), 'DES-EDE3', md5( GI_TOOLKIT_PLUGIN_URL ), OPENSSL_RAW_DATA ) );
    }
	...
	private function decrypt( $encrypted_author_slug ) {
        ...
        return base_convert( openssl_decrypt( pack('H*', $encrypted_author_slug), 'DES-EDE3', md5( GI_TOOLKIT_PLUGIN_URL ), OPENSSL_RAW_DATA ), 36, 10 );
    }
}
