 ...
 * @since 1.0.0
 */
class Gi_Toolkit_Disable_Gutenberg {
    ...
    public function __construct() {
        ...
        $this->option_id                        = GI_TOOLKIT_PLUGIN_SETTINGS . '_disable_gutenberg';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Disable Gutenberg', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        ...
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-disable-gutenberg', 
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/disable-gutenberg.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/disable-gutenberg.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/disable-gutenberg.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc"><?php esc_html_e('Deactivate the Gutenberg block editor selectively, allowing you to control its usage for specific or all relevant post types.', 'gi-toolkit'); ?></div>
                <div class="gi-toolkit__section__body">
                    <div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Disable Gutenberg block editor via post type', 'gi-toolkit'); ?></div>
                    ...
                    <div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Disable Gutenberg in frontend', 'gi-toolkit'); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
                            <div class="gi-toolkit__checkbox">
                                <label class="gi-toolkit__checkbox__label">
                                    ...
                                    <span class="mark"></span>
                                    <span class="gi-toolkit__checkbox__label__text"><?php esc_html_e('Disable frontend block styles / CSS files for the selected post types.', 'gi-toolkit'); ?></span>
                                </label>
                            </div>
                        </div>
                    </div>
                    <div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Disable Gutenberg Widgets', 'gi-toolkit'); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
                            <div class="gi-toolkit__checkbox">
                                <label class="gi-toolkit__checkbox__label">
                                    ...
                                    <span class="mark"></span>
                                    <span class="gi-toolkit__checkbox__label__text"><?php esc_html_e('Restores the classic widgets settings screen when using a classic (non-block) theme. This has no effect on block themes.', 'gi-toolkit'); ?></span>
                                </label>
                            </div>
                        </div>
                    </div>
