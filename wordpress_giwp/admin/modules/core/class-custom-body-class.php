 ...
 * @since 1.3.0
 */
class Gi_Toolkit_Custom_Body_Class {

    const CUSTOM_BODY_CLASS_ID = '_gi_toolkit_custom_body_class';
    ...
    public function __construct() {
        ...
        $this->option_id        = GI_TOOLKIT_PLUGIN_SETTINGS . '_custom_body_class';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Custom Body Class', 'gi-toolkit' );
    }
    ...
    public function add_meta_box( $post_type, $post ) {
        ...
        if ( '1' === $is_enabled ) {
            ...
            add_meta_box(
                'gi-toolkit-custom-body-class',
                sprintf( 
                    /* translators: %s: module title */
                    __( 'GI-Toolkit(%s)', 'gi-toolkit' ), 
                    $this->header_title 
                ),
    ...
    public function render_meta_box( $post ) {
        ...
        ?>
            <div>
                ...
                <div><?php echo esc_html_e( 'Use comma to separate multiple classes. Example: myclass,myother-class', 'gi-toolkit' ); ?></div>
            </div>
        <?php
    }
    ...
    public function add_submenu(){
        ...
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-custom-body-class', 
    ...
    public function render_submenu() {
        ...
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/custom-body-class.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/custom-body-class.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/custom-body-class.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
    ...
    private function submenu_content() {
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc"><?php esc_html_e('Add custom <body> class(es) on the singular view of some or all public post types.', 'gi-toolkit'); ?></div>
                <div class="gi-toolkit__section__body">
                    <div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e('Add metabox in', 'gi-toolkit'); ?></div>
