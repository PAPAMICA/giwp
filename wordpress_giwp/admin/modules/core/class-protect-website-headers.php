 ...
 * @since 1.9.0
 */
class Gi_Toolkit_Protect_Website_Headers {
    ...
    public function __construct() {
        $this->option_id    = GI_TOOLKIT_PLUGIN_SETTINGS . '_protect_website_headers';
    ...
    public function class_init() {
        $this->header_title = esc_html__( 'Protect Website Headers', 'gi-toolkit' );
    }
    ...
    public function add_submenu(){
        Gi_Toolkit_Settings::add_submenu_page(
            ...
            $this->header_title,
            'manage_options',
            'gi-toolkit-settings-protect-website-headers',
    ...
    public function render_submenu() {
        $submenu_assets = include( GI_TOOLKIT_PLUGIN_PATH . 'admin/assets/build/core/protect-website-headers.asset.php' );
        wp_enqueue_style( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/protect-website-headers.css', array(), $submenu_assets['version'], 'all' );
        wp_enqueue_script( 'Gi_Toolkit_submenu', GI_TOOLKIT_PLUGIN_URL . 'admin/assets/build/core/protect-website-headers.js', $submenu_assets['dependencies'], $submenu_assets['version'], true );
	...
	private static function update_htaccess() {
        ...
        if ( $is_apache ) {
            ...
            if ( !empty( $content ) ) {
                Gi_Toolkit_Htaccess::add( wp_unslash( $content ), self::MODULE_ID );
            }
        }
	}
    ...
    private function get_default_settings(){
        ...
        return array(
			...
			'x_frame_options'                       => array(
				'value'   => 'SAMEORIGIN',
				'options' => array(
					'DENY'       => __( 'DENY', 'gi-toolkit' ),
					'SAMEORIGIN' => __( 'SAMEORIGIN', 'gi-toolkit' ),
					'ALLOW-FROM' => __( 'ALLOW-FROM', 'gi-toolkit' ),
				),
			),
        ...
        ?>
            <div class="gi-toolkit__section">
                <div class="gi-toolkit__section__desc">
					<?php esc_html_e( "Add security headers quickly to your site to protect it from threats such as phishing attacks, data theft and more.", 'gi-toolkit'); ?>
				</div>
                <div class="gi-toolkit__section__body">
					...
					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title">
							<?php esc_html_e( 'Resolve duplicate site headers', 'gi-toolkit' ); ?>
                        ...
                        <div class="gi-toolkit__section__body__item__content">
							<div class="gi-toolkit__checkbox">
								<label class="gi-toolkit__checkbox__label">
									...
									<span class="gi-toolkit__checkbox__label__text"><?php esc_html_e( 'Disable (Strict-Transport-Security).', 'gi-toolkit' ); ?></span>
								</label>
							</div>
							<div class="gi-toolkit__checkbox">
								<label class="gi-toolkit__checkbox__label">
									...
									<span class="mark"></span>
									<span class="gi-toolkit__checkbox__label__text"><?php esc_html_e( 'Disable (Permissions-Policy).', 'gi-toolkit' ); ?></span>
								</label>
							</div>
							<div class="gi-toolkit__checkbox">
								<label class="gi-toolkit__checkbox__label">
									...
									<span class="mark"></span>
									<span class="gi-toolkit__checkbox__label__text"><?php esc_html_e( 'Disable (X-Content-Type-Options).', 'gi-toolkit' ); ?></span>
								</label>
							</div>
							<div class="gi-toolkit__checkbox">
								<label class="gi-toolkit__checkbox__label">
									...
									<span class="mark"></span>
									<span class="gi-toolkit__checkbox__label__text"><?php esc_html_e( 'Disable (X-Frame-Options).', 'gi-toolkit' ); ?></span>
								</label>
							</div>
                        </div>
                    </div>
					...
					<div class="gi-toolkit__section__body__item">
                        ...
                        <div class="gi-toolkit__section__body__item__content">
							...
							<div class="description"><?php esc_html_e( 'Enter your custom URL (Sentry, URIports, Datadog, and Report URI) for CSP violation reports.', 'gi-toolkit' ); ?></div>
                        </div>
                    </div>

					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'Permissions Policy Contents', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							<div class="gi-toolkit__textarea">
							...
							<div class="description"><?php esc_html_e( 'The HTTP Permissions-Policy header provides a mechanism to allow and deny the use of browser features in a document or within any <iframe> elements in the document.', 'gi-toolkit' ); ?></div>
						</div>
                    </div>

					<div class="gi-toolkit__section__body__item">
                        <div class="gi-toolkit__section__body__item__title"><?php esc_html_e( 'X-Frame-Options', 'gi-toolkit' ); ?></div>
                        <div class="gi-toolkit__section__body__item__content">
							<div class="gi-toolkit__select">
                                <select name="<?php echo esc_attr( $this->option_id . '[x_frame_options][value]' ); ?>" id="JS-gi_toolkit-x-frame-options-select">
							...
							<div class="gi-toolkit__input-text" <?php echo $x_frame_value != 'ALLOW-FROM' ? 'style="display: none;"' : ''; ?> id="JS-gi_toolkit-x-frame-options-input">
