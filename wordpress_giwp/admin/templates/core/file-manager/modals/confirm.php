		...
		<div class="modal-dialog" role="document">
			<form class="modal-content rounded-3 shadow" method="post" autocomplete="off" action="<%this.action%>"><?php //phpcs:ignore Generic.PHP.DisallowAlternativePHPTags.MaybeASPOpenTagFound?>
				<div class="modal-body p-4 text-center">
					<h5 class="mb-2"><?php esc_html_e( 'Are you sure want to', 'gi-toolkit' ); ?> <%this.title%> ?</h5><?php //phpcs:ignore Generic.PHP.DisallowAlternativePHPTags.MaybeASPOpenTagFound?>
				...
				<div class="modal-footer flex-nowrap p-0">
					...
					<button type="submit" class="btn btn-lg btn-link fs-6 text-decoration-none col-6 m-0 rounded-0" data-bs-dismiss="modal"><strong><?php esc_html_e( 'Okay', 'gi-toolkit' ); ?></strong></button>
				</div>
			</form>
		</div>
	</div>
