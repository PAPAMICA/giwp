...
<div class="gi-toolkit-popup">
	...
	<div class="gi-toolkit-popup__content">
		...
		<div class="gi-toolkit-popup__body">
			<div class="gi-toolkit-popup__body__text"><?php esc_html_e( 'Please note that you have just changed the "Post Key" of your Custom Post Type and we have detected existing content for this CPT. Choose how you would like to resolve this change:', 'gi-toolkit' ); ?></div>
			<div class="gi-toolkit-popup__body__content">
				<div class="gi-toolkit-popup__body__content__item">
					<label class="gi-toolkit-popup__body__content__item__label">
						...
						<?php esc_html_e( 'Migrate all “posts”:', 'gi-toolkit' ); ?>
				...
				<div class="gi-toolkit-popup__body__content__item">
					<label class="gi-toolkit-popup__body__content__item__label">
						...
						<span class="custom-radio"></span>
						<?php esc_html_e( 'Delete all “posts” with old Post Key:', 'gi-toolkit' ); ?>
						<span class="old"></span>
					</label>
				</div>
				<div class="gi-toolkit-popup__body__content__item">
