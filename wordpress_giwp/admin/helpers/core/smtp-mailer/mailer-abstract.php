...
include_once GI_TOOLKIT_PLUGIN_PATH . 'admin/modules/core/class-smtp-mailer.php';
 ...
 * @since 2.14.0
 */
abstract class Gi_Toolkit_SMTP_Mailer_Abstract {
	...
	public function __construct( $phpmailer ) {
		...
		$this->class_smtp_mailer = new Gi_Toolkit_SMTP_Mailer();
	...
	public function get_body() {
		...
		return apply_filters( 'gi_toolkit_smtp_mailer_get_body', $this->body, $this->provider );
	}
	...
	public function get_headers() {
		...
		return apply_filters( 'gi_toolkit_smtp_mailer_get_headers', $this->headers, $this->provider );
	}
